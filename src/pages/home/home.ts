          ...
          handler: () => {
            this.storage.get('securityKey').then((sec) => {
              ...
              for (var i = 0, len = this.teams.length; i < len; i++) {
                ...
                var params = 'securityKey=' + sec + '&name=' + this.teams[i]['teamName'] + '&number=' + this.teams[i]['teamNumber'] + '&groundCubes=' + this.teams[i]['groundCubes'] + '&returnCubes=' + this.teams[i]['returnCubes'] + '&stackCubes=' + this.teams[i]['stackCubes'] + '&switch=' + this.teams[i]['switch'] + '&scale=' + this.teams[i]['scale'] + '&climb=' + this.teams[i]['climb'] + '&wins=' + this.teams[i]['wins'] + '&losses=' + this.teams[i]['losses'];    
